...
void em1_led1_set_bri(float _duty100) {
	ESP_ERROR_CHECK(ledc_set_duty(em1_led1_mode, em1_led1_ch, em1_led1_duty(_duty100)));
	ESP_ERROR_CHECK(ledc_update_duty(em1_led1_mode, em1_led1_ch));
}

void em1_led1_init(float duty100) {
	ledc_timer_config_t ledc_timer = {.speed_mode = em1_led1_mode,
			.timer_num = LEDC_TIMER_0, .duty_resolution = em1_led1_duty_res,
			.freq_hz = 5000, .clk_cfg = LEDC_AUTO_CLK};

	ledc_channel_config_t ledc_channel = {.speed_mode = em1_led1_mode,
			.channel = em1_led1_ch, .timer_sel = ledc_timer.timer_num,
			.intr_type = LEDC_INTR_DISABLE, .gpio_num = 5,
			.duty = em1_led1_duty(duty100), .hpoint = 0};
